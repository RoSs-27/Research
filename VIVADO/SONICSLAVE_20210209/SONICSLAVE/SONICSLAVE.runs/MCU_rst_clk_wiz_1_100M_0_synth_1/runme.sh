...
HD_PWD='C:/proj_VolumeDisplay/fpga/SONICSLAVE/SONICSLAVE.runs/MCU_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCU_rst_clk_wiz_1_100M_0.tcl
