...
HD_PWD='C:/proj_VolumeDisplay/fpga/SONICSLAVE/SONICSLAVE.runs/MCU_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCU_mdm_1_0.tcl
