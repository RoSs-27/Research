...
HD_PWD='C:/proj_VolumeDisplay/fpga/SONICSLAVE/SONICSLAVE.runs/MCU_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCU_dlmb_v10_0.tcl
