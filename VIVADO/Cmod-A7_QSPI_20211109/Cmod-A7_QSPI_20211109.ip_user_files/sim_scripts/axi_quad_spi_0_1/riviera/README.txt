...
#
# Generated by export_simulation on Thu Nov 11 18:27:29 +0900 2021
#
################################################################################
...
'-reset_run' switch to the './axi_quad_spi_0.sh' script.

./axi_quad_spi_0.sh -reset_run
...
./axi_quad_spi_0.sh -noclean_files

For more information on the script, please type './axi_quad_spi_0.sh -help'.
