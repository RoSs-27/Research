...
HD_PWD='C:/proj_sasaoka/Display3D/Display3D.runs/MCU_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCU_xbar_0.tcl
