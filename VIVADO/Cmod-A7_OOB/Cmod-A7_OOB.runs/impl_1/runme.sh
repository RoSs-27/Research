...
HD_PWD='C:/Users/b183r035m/Documents/workspace/VIVADO/Cmod-A7_OOB/Cmod-A7_OOB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log user_35t_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source user_35t_wrapper.tcl -notrace
