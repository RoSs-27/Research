...
HD_PWD='D:/Github/releases/in-work/Cmod-A7/not-reset/Cmod-A7-35T-OOB/proj/Cmod-A7-35T-OOB.runs/user_35t_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_35t_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_35t_xlconcat_0_0.tcl
